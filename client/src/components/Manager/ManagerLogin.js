            ...
            <div>
                ...
                <div id="login">
                    <form className="form_white-bg">
                        ...
                        <input className="form-input" required type="text" placeholder="username" name="username" />
                 
                        <input className="form-input" required type="password" placeholder="password" name="password" /><br />
